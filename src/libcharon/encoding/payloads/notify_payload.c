...
ENUM_NEXT(notify_type_names, USE_BEET_MODE, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"USE_BEET_MODE");
ENUM_NEXT(notify_type_names, ME_MEDIATION, SA_RESOURCE_INFO, USE_BEET_MODE,
	"ME_MEDIATION",
	"ME_ENDPOINT",
	"ME_CALLBACK",
	"ME_CONNECTID",
	...
	"RADIUS_ATTRIBUTE",
	"SA_RESOURCE_INFO",);
ENUM_END(notify_type_names, SA_RESOURCE_INFO);
...
ENUM_NEXT(notify_type_short_names, USE_BEET_MODE, USE_BEET_MODE, UNITY_LOAD_BALANCE,
	"BEET_MODE");
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, SA_RESOURCE_INFO, USE_BEET_MODE,
	"ME_MED",
	"ME_EP",
	"ME_CB",
	"ME_CID",
	...
	"RADIUS",
	"RES_INFO");
ENUM_END(notify_type_short_names, SA_RESOURCE_INFO);
